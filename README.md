...
* Learning Objective: This project focuses on modular Python code, container orchestration with Docker, and efficient package management using uv.
...
Bash
* docker compose run --rm taxi_pipeline --year 2024 --month 1
...
* Bash
for m in {1..12}; do docker compose run --rm taxi_pipeline --year 2024 --month $m; done